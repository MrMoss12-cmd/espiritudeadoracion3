    ...
    <section className="min-h-screen flex items-center justify-center animated-gradient py-20 px-4 overflow-hidden">
      ...
      >
        ...
        >
          ...
          online quizzes and discussion forums - and gain a deeper understanding of God Word. 
          Whether youre a beginner or experienced student, Bible College will help you develop your 
